...
public class AddCompanyOfferPOJO {
    ...
    public AddCompanyOfferPOJO() {
    }

    public AddCompanyOfferPOJO(int offer_id, byte[] offer_logo, String offer_title, String offer_explaination, double offer_cost,
    ...
    public AddCompanyOfferPOJO(byte[] offer_logo, String offer_title, String offer_explaination, double offer_cost,
                               String offer_display_date, String offer_expired_date, String offer_deliver_date, int company_id) {
        this.offer_logo = offer_logo;
        this.offer_title = offer_title;
        this.offer_explaination = offer_explaination;
